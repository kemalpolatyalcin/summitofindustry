...
const SOCIAL_LINKS = { instagram: "https://www.instagram.com/emuieclub", linkedin: "https://www.linkedin.com/company/emu-industrial-engineering-society/" };
  ...
  useEffect(() => {
    const handleFirstInteraction = () => {
      if (audioRef.current) {
        ...
        audioRef.current.play().catch(e => console.log("Ambient error", e));
      }
  ...
  return (
    <>
      ...
      <main className="relative flex flex-col min-h-screen w-full overflow-x-hidden bg-[#050505] text-white selection:bg-[#00A3FF] selection:text-white font-sans fade-in">
        ...
        <nav className="fixed top-0 w-full z-40 px-2 sm:px-4 md:px-8 h-16 md:h-20 flex justify-between items-center bg-black/80 md:bg-black/20 md:backdrop-blur-md border-b border-white/5 transition-all duration-300">
          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4 relative z-20">
            <div className="flex items-center text-[10px] md:text-xs font-bold font-mono border border-white/20 rounded-full bg-black/40 overflow-hidden">
              <button onClick={() => setLang('tr')} className={`px-3 py-2 md:px-4 md:py-2 transition-colors duration-300 hover:bg-white/10 hover:text-white ${lang === 'tr' ? 'text-[#00A3FF]' : 'text-gray-500'}`}>TR</button>
              <span className="text-gray-600">|</span>
              <button onClick={() => setLang('en')} className={`px-3 py-2 md:px-4 md:py-2 transition-colors duration-300 hover:bg-white/10 hover:text-white ${lang === 'en' ? 'text-[#00A3FF]' : 'text-gray-500'}`}>EN</button>
            </div>
            <MagneticButton onClick={() => window.open(GOOGLE_FORM_URL, '_blank')} className="px-3 py-2 md:px-6 md:py-3 border border-white/20 bg-[#00A3FF] md:bg-white/5 md:backdrop-blur-md text-white text-[10px] md:text-sm font-bold tracking-wide rounded-lg shadow-lg hover:bg-white hover:text-[#00A3FF] hover:border-[#00A3FF] hover:shadow-[0_0_20px_#00A3FF]">
              {t.nav.join}
            </MagneticButton>
            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="lg:hidden text-white p-2 hover:scale-110 transition-transform">
              {mobileMenuOpen ? '✕' : '☰'}
            </button>
          </div>
        </nav>
        ...
        <section className="relative z-10 flex flex-col items-center justify-start w-full pt-28 md:pt-36 pb-8 min-h-[85vh] md:min-h-[90vh]">
          ...
          <div className="relative z-10 flex flex-col items-center w-full px-4 mt-8 md:mt-10 slide-up">
            <button onClick={() => window.open(GOOGLE_FORM_URL, '_blank')} className="px-8 py-4 md:px-12 md:py-5 mb-8 md:mb-10 bg-[#00A3FF] text-white font-bold text-lg md:text-xl tracking-widest rounded-xl shadow-[0_0_30px_rgba(0,163,255,0.4)] hover:scale-110 hover:bg-[#33B5FF] hover:shadow-[0_0_50px_#00A3FF] active:scale-95 transition-all duration-300 border border-white/20 w-full sm:w-auto md:max-w-md">
              {t.hero.btn_reg}
            </button>
        ...
        <div className="relative z-10 bg-[#050505] pb-16 md:pb-20 border-t border-white/5">
          ...
          <section id="speakers" className="w-full max-w-7xl mx-auto py-16 md:py-24 px-4 md:px-6 scroll-mt-20 md:scroll-mt-24 slide-up">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3 md:gap-10">
              {speakers.map((speaker, index) => (
                <div key={index} onClick={() => setSelectedSpeaker(speaker)} className="relative h-[250px] md:h-[450px] lg:h-[500px] w-full rounded-xl md:rounded-3xl overflow-hidden cursor-pointer group border border-white/10 shadow-[0_10px_20px_rgba(0,0,0,0.5)] md:hover:shadow-[0_0_40px_rgba(0,163,255,0.3)] transition-all duration-500 md:hover:-translate-y-2 perspective-1000">
                  ...
                  <div className="absolute inset-0 p-3 lg:p-8 flex flex-col justify-end translate-y-0 md:translate-y-4 md:group-hover:translate-y-0 transition-transform duration-500">
                    <h3 className="text-sm md:text-3xl font-bold text-white mb-1 md:mb-2 leading-tight drop-shadow-[0_4px_4px_rgba(0,0,0,1)] md:drop-shadow-md">{speaker.name}</h3>
                    <div><span className="inline-block bg-black/70 md:bg-transparent backdrop-blur-md md:backdrop-blur-none text-[#00A3FF] px-2 py-1 md:px-0 md:py-0 rounded-md md:rounded-none text-[8px] md:text-sm font-bold tracking-widest uppercase mb-2 md:mb-4 border border-white/10 md:border-transparent drop-shadow-lg md:drop-shadow-md">{speaker.title}</span></div>
                    <div className="h-[2px] w-6 md:w-12 bg-[#00A3FF] mb-2 md:mb-4 md:group-hover:w-24 transition-all duration-500"></div>
                    <div className="hidden md:flex items-center gap-2 text-[11px] md:text-sm text-gray-300 md:group-hover:text-white transition-colors duration-300 opacity-100 md:opacity-0 md:group-hover:opacity-100"><span className="font-semibold tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,1)] md:drop-shadow-none">{t.sections.view_profile}</span><span className="md:group-hover:translate-x-2 transition-transform duration-300 drop-shadow-[0_2px_4px_rgba(0,0,0,1)] md:drop-shadow-none">→</span></div>
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-20 md:mt-32">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-3 md:gap-10">
                {panelSpeakers.map((speaker, index) => (
                  <div key={index} onClick={() => setSelectedSpeaker(speaker)} className="relative h-[250px] md:h-[450px] w-full rounded-xl md:rounded-3xl overflow-hidden cursor-pointer group border border-[#00A3FF]/20 shadow-[0_5px_15px_rgba(0,163,255,0.1)] md:hover:shadow-[0_0_40px_rgba(0,163,255,0.4)] transition-all duration-500 md:hover:-translate-y-2 perspective-1000">
                    <img src={speaker.image} alt={speaker.name} className={`absolute inset-0 w-full h-full object-cover transition-transform duration-1000 md:group-hover:scale-110 ${speaker.imgClass}`} onError={(e) => { e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(speaker.name)}&background=0D8ABC&color=fff&size=512`; }} />
                    ...
                    <div className="absolute inset-0 p-3 lg:p-8 flex flex-col justify-end translate-y-0 md:translate-y-4 md:group-hover:translate-y-0 transition-transform duration-500">
                      <h3 className="text-sm md:text-2xl font-bold text-white mb-1 md:mb-2 leading-tight drop-shadow-[0_4px_4px_rgba(0,0,0,1)] md:drop-shadow-md">{speaker.name}</h3>
                      <div><span className="inline-block bg-black/70 md:bg-transparent backdrop-blur-md md:backdrop-blur-none text-[#00A3FF] px-2 py-1 md:px-0 md:py-0 rounded-md md:rounded-none text-[8px] md:text-xs font-bold tracking-widest uppercase mb-2 md:mb-4 border border-white/10 md:border-transparent drop-shadow-lg md:drop-shadow-md">{speaker.title}</span></div>
                      <div className="h-[2px] w-6 md:w-12 bg-[#00A3FF] mb-2 md:mb-4 md:group-hover:w-24 transition-all duration-500"></div>
                      <div className="hidden md:flex items-center gap-2 text-[10px] md:text-sm text-gray-300 md:group-hover:text-white transition-colors duration-300 opacity-100 md:opacity-0 md:group-hover:opacity-100"><span className="font-semibold tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,1)] md:drop-shadow-none">{t.sections.view_profile}</span><span className="md:group-hover:translate-x-2 transition-transform duration-300 drop-shadow-[0_2px_4px_rgba(0,0,0,1)] md:drop-shadow-none">→</span></div>
                    </div>
                  </div>
                ))}
              </div>
